    ...
    public class CustomerServiceTests
    {
        ...
        public class When_creating_multiple_customers
        {
            ...
            public void the_customer_repository_should_be_called_once_per_customer()
            {
                ...
                var mockRepo = new Mock<ICustomerRepository>(); // mockRepo is of type Mock<ICustomerRepository>

                var customerService = new CustomerService(mockRepo.Object); //CustomerService ctor expects an ICustomerRepository, so call .Object prop
                ...
                //Assert
                mockRepo.Verify(x => x.Save(It.IsAny<Customer>()), 
